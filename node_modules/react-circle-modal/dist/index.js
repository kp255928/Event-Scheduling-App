...
var usePortal = _interopDefault(require('react-useportal'));
...
var useModal = function useModal(initialStatus) {
  ...
  var _useState = React.useState(initialStatus),
      status = _useState[0],
...
var ReactCircleModal = React__default.forwardRef(function (_ref, ref) {
  ...
  var _useState = React.useState(modalStatus),
  ...
  reactUse.useLockBodyScroll(modalStatus);
  ...
  return React__default.createElement(React.Fragment, null, toogleComponent(function (event) {
    setPositions({
      left: event.clientX,
      top: event.clientY
    });
...
exports.ReactCircleModal = ReactCircleModal;
exports.default = ReactCircleModal;
